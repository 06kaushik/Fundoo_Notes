...
import { COLOR, FLEX, MARGIN } from '../Utility/Styling';
...
export default function EditeLabelScreen(props) {
  ...
  var labelForCreateScreen=()=>{
   let filterLabelArray=[]
    ...
    navigation.navigate('EditNoteScreen',{labelArrDataState:filterLabelArray,labelArrayTrueFalse:true})
  }
